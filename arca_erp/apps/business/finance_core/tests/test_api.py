...
class ChartOfAccountsAPITest(APITestCase):
    ...
    def setUp(self):
        ...
        self.list_url = reverse('chartofaccounts-list')
    ...
    def test_create_chart_of_accounts(self):
        ...
        response = self.client.post(self.list_url, new_account_data, format='json')
...
class JournalAPITest(APITestCase):
    ...
    def test_post_journal_action(self):
        ...
        url = reverse('journal-post-journal', kwargs={'pk': journal.pk})
